		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#itorogelportaleordini-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelportaleordini-display": {
								"semanticObject": "itorogelportaleordini",
								"action": "display",
								"description": "App portale ordini",
								"title": "Portale Ordini",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.portaleordini",
									"url": sap.ui.require.toUrl("it/orogel/portaleordini")
								}
							}
						}
					}
